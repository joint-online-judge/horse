...
Revision ID: 91354e3dc7d7
Revises:
Create Date: 2021-10-31 19:18:20.465116
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("num_submit", sa.Integer(), nullable=True),
        sa.Column("num_accept", sa.Integer(), nullable=True),
        sa.Column("scoreboard_hidden", sa.Boolean(), nullable=True),
        sa.ForeignKeyConstraint(["domain_id"], ["domains.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["owner_id"], ["users.id"], ondelete="RESTRICT"),
        sa.PrimaryKeyConstraint("id"),
    )
